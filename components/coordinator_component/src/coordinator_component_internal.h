...
extern coordinator_ctx_t *g_coordinator_ctx;

esp_err_t init_coordinator_events(coordinator_ctx_t *ctx);

esp_err_t shutdown_coordinator_events(coordinator_ctx_t *ctx);

esp_err_t send_coordinator_error_event(coordinator_event_id_t event_type, esp_err_t *event_data, coordinator_error_code_t coordinator_error_code);
