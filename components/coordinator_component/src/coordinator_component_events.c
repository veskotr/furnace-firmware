...
const char *TAG = "COORDINATOR_EVENTS";
...
static void coordinator_event_handler(void *handler_arg, esp_event_base_t base, int32_t id, void *event_data)
{
    ...
    case COORDINATOR_EVENT_START_PROFILE:
    {
        ...
        if (err != ESP_OK)
        {
            CHECK_ERR_LOG(send_coordinator_error_event(COORDINATOR_EVENT_ERROR_OCCURRED, &err, COORDINATOR_ERROR_NOT_STARTED),
    ...
    case COORDINATOR_EVENT_PAUSE_PROFILE:
    {
        ...
        if (err != ESP_OK)
        {
            CHECK_ERR_LOG(send_coordinator_error_event(COORDINATOR_EVENT_ERROR_OCCURRED, &err, COORDINATOR_ERROR_PROFILE_NOT_PAUSED),
    ...
    case COORDINATOR_EVENT_STOP_PROFILE:
    {
        ...
        if (err != ESP_OK)
        {
            CHECK_ERR_LOG(send_coordinator_error_event(COORDINATOR_EVENT_ERROR_OCCURRED, &err, COORDINATOR_ERROR_PROFILE_NOT_STOPPED),
    ...
    case COORDINATOR_EVENT_RESUME_PROFILE:
    {
        ...
        if (err != ESP_OK)
        {
            CHECK_ERR_LOG(send_coordinator_error_event(COORDINATOR_EVENT_ERROR_OCCURRED, &err, COORDINATOR_ERROR_PROFILE_NOT_RESUMED),
    ...
    case COORDINATOR_EVENT_GET_STATUS_REPORT:
    {
        ...
        CHECK_ERR_LOG(send_coordinator_event(COORDINATOR_EVENT_GET_STATUS_REPORT, &state, sizeof(heating_task_state_t)),
...
esp_err_t send_coordinator_error_event(coordinator_event_id_t event_type, esp_err_t *esp_error, coordinator_error_code_t coordinator_error_code)
{
